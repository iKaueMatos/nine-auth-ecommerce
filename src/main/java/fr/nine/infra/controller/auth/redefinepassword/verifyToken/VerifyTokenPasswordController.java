package fr.nine.infra.controller.auth.redefinepassword.verifyToken;
...
public class VerifyTokenPasswordController {
  ...
  public ResponseEntity<String> handle(@RequestParam String email, @RequestParam String token) {
    try {
